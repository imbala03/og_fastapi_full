...
DATABASE_URLS = {
    # Keep secrets out of source control. For local dev, set DATABASE_URL in your environment/.env.
    "dev_local": os.getenv("DEV_DATABASE_URL", "postgresql://postgres:CHANGE_ME@localhost:5432/og_database"),
    # On Render, DATABASE_URL is set automatically when the DB is linked (see render.yaml).
